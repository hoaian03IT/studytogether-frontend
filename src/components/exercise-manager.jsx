		...
		<Modal isOpen={isOpen} onClose={onClose} size='xl'>
			<ModalContent>
				<form onSubmit={handleSubmit}>
					<ModalHeader>
						{action === "insert" ? "Question Insert" : action === "edit" ? "Question Edit" : ""}
					</ModalHeader>
					<ModalBody>
						<Tabs
							aria-label='Options'
									...
									<div>
										...
										<Select
											...
											{difficulties.map((difficulty) => (
												<SelectItem key={difficulty.key} color={difficulty.color}>
													{difficulty.title}
												</SelectItem>
											))}
										</Select>
