			...
			<div className="space-y-4 w-full flex flex-col items-center">
				...
				<div className="w-full grid grid-cols-2 gap-4">
					{optionsForUser?.map((item, index) =>
						<Button
							className={clsx("col-span-1 h-16 text-black text-xl hover:-translate-y-1 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]", isSubmitted ? "pointer-events-none" : "pointer-events-auto")}
							key={index}
							variant={isSubmitted ? "shadow" : "bordered"}
							color={isSubmitted && item === answer ? "success" : isSubmitted && !isCorrect && selectedAnswer === item ? "danger" : "default"}
