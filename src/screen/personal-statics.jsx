    ...
    <div className="p-8 bg-gray-100 min-h-screen">
      ...
      <div className="flex">
        ...
        <div className="flex-grow pl-6">
          ...
          <Progress color="warning" aria-label="Loading..." value={60} className="max-w-2xl"/>
          ...
          <div className="flex items-center justify-between">
            ...
            <button className="px-4 py-2 bg-blue-500 text-white text-sm font-semibold rounded-lg shadow-md hover:bg-blue-600">
              Continue →
            </button>
          </div>
        </div>
