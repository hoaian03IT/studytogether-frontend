  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 p-8 bg-gray-100">
      ...
      <div className="flex justify-center gap-4 mb-6">
        {/* Nút PayPal */}
        <button onClick={() => handlePaymentClick('paypal')} className="flex flex-col items-center">
        ...
        {/* Nút VNPay */}
        <button onClick={() => handlePaymentClick('vnpay')} className="flex flex-col items-center">
          <img src="src/assets/vnp-logo.png" alt="VNPAY" className="w-12 cursor-pointer" />
      ...
      <div className={`overflow-hidden transition-all duration-300 ease-in-out ${selectedPaymentMethod ? 'max-h-40 opacity-100' : 'max-h-0 opacity-0'}`}>
        ...
        {selectedPaymentMethod === 'vnpay-qr' && (
          <div className="p-4 border-t border-gray-300">
            <p className="text-gray-600">Thanh toán bằng VNPay QR</p>
          </div>
        )}
      </div>
    </div>
